//===- FixedCommandLine.h - Command line handler ----------------*- C++ -*-===//
//
// Part of the SWPP Project, but not part of the LLVM Project,
// don't see https://llvm.org/LICENSE.txt for license information.
...
//===----------------------------------------------------------------------===//
//
// This FixedCommandLine.h fixes the trolling that happened 16 years ago.
// Although it's not allowed to cast enum to unsigned via reinterpret_cast,
// somehow commit c220ecf thought the opposite way and trolled LLVM community.
// Good job, Reid Spencer!
//
//===----------------------------------------------------------------------===//
